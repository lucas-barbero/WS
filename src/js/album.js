...
function setCover(album) {
  ...
  sparqlQuery(query).then(function (data) {
    ...
    var strCrypted = md5(str).toString();
    var strFirst = strCrypted.substring(0,1);
    var strFirstTwo = strCrypted.substring(0,2);
    var strFinal = "https://upload.wikimedia.org/wikipedia/en/" +strFirst+ "/" +strFirstTwo+ "/" +str;
    var image = new Image();
    image.src = strFinal;
